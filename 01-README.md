...
<b>>git push --set-upstream origin master</b></p></br>
    ...
    "git push": Envia os seus commits locais para um repositório online (como o GitHub ou GitLab).</br>
    "--set-upstream (ou apenas -u)": Cria um vínculo (rastreamento) entre a sua branch atual e a branch remota.</br>
    "origin": É o nome padrão que o Git dá ao endereço do seu repositório remoto na internet.</br>
    "master": É o nome da ramificação (branch) do seu projeto</br>
