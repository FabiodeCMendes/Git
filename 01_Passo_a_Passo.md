...
Use git pull antes de começar a trabalhar: Isso garante que você está escrevendo código em cima da versão mais recente do projeto, evitando conflitos com o trabalho dos seus colegas.
...
<img src="imgs/passo1.png" alt="fabric" width="500px">


## Subir as alterações da branch local para a remota:

Use git push após finalizar e buildar sua tarefa: Assim que você fizer suas alterações e criar um commit localmente, use o comando para salvar o progresso de forma segura na nuvem.

>git push origin master
>git push origin main

<img src="imgs/passo2.png" alt="fabric" width="500px">
...
<img src="imgs/passo3.png" alt="fabric" width="500px">
...
##Git log
Comparar a lista de commits entre as branchesCaso queira ver o histórico de mensagens de commits que existem em uma branch, mas não na outra, utilize o comando git log
